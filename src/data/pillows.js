const pillows = [
    ...
    },
    {
        ...
        name: 'Сердечко',
        description:
            'Коли подушку сплетено з пряжі "травичка" - це означає лише одне, що всі хотітимуть її торкнутись. Дуже легенька, м\'яка та романтична за кольором та формою подушка-сердечко. Має пухнасту поверхню, гіпоалергенний наповнювач, створена для обіймів та відпочинку.',
    ...
    },
    {
        ...
        description:
            "Подушку-іграшку плетено та пошито повністю вручну, з цікавим поєднанням кольорів та фактур. Жовта пряжа має дуже гарну об'ємну букльовану фактуру, коричнева - м'якенький однотонний акрил. Виріб плетено спицями, деталі - гачком, мордочка вишита вручну. Песик має гіпоалергенне наповнення - холофайбер. Така подушка стане чудовою окрасою будь-якого інтер'єру та додасть в оселю тепла.",
