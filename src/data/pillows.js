const pillows = [
    ...
    {
        id: 42,
        name: 'Котик смугастохвостий',
        description:
            "Мінімалізм в тренді, тож ця модель котоПодушки, як ніколи - на часі! Плетений вручну з гарної меланжевої пряжі - котоподух має неймовірний вигляд та супер-приємний на дотик. Сподіваємось, що цей смугастий хвіст не залишить вас байдужими.",
        materials: 'Матеріали: акрил (пряжа), холофайбер (наповнювач).',
        dimensions: 'Розмір: 38/29/15см.',
        images: [
            'kotyk-smuhastokhvostyi-01.jpg',
            'kotyk-smuhastokhvostyi-02.jpg',
            'kotyk-smuhastokhvostyi-03.jpg',
            'kotyk-smuhastokhvostyi-04.jpg',
            'kotyk-smuhastokhvostyi-05.jpg',
            'kotyk-smuhastokhvostyi-06.jpg',
        ],
        price: 700,
        link: 'kotyk-smuhastokhvostyi',
        category: 'Подушки',
    },
    {
        id: 43,
        name: 'Смугач сірий',
        description:
            "Ця модель котоПодуха - одна з найпопулярніших і може здатись, що таких подушок було вже багато, але, якщо порівняти всі, сплетені в попердні роки подушки-іграшки такої моделі, ви не знайдете подібних. Так як ми використовуємо нитки повторно, підібрати однакові для виробів важко і повторюються в схожих кольорах лише деякі моделі, якщо, наприклад, було розпущено якесь покривало чи великий светр. Тож, всі сірі смугачі - неповторні, бо сірі ниточки гарної якості не так часто зустрічаються. Подух з цього допису - в наявності і може стати вашим.",
        materials: 'Матеріали: акрил (пряжа), холофайбер (наповнювач).',
        dimensions: 'Розмір: 38/29/14см.',
        images: [
            'smuhach-siryi-01.jpg',
            'smuhach-siryi-02.jpg',
            'smuhach-siryi-03.jpg',
            'smuhach-siryi-04.jpg',
            'smuhach-siryi-05.jpg',
            'smuhach-siryi-06.jpg',
            'smuhach-siryi-07.jpg',
        ],
        price: 950,
        link: 'smuhach-siryi',
        category: 'Подушки',
